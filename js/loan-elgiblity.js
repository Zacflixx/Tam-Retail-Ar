 function eligiable() {
     ...
     if (incomereq > P1) {
         ...
         document.formval3.field11.value = (("SR " + P1 + " at EMI " + "SR " + emi1.toFixed(0)));
         document.formval3.field12.value = ("You are Eligible for a maximum loan of " + ("SR " + incomereq + " at EMI " + "SR " + emi2.toFixed(0)));
